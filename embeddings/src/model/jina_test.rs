use super::jina::{validate_model, JinaModel};
use super::TextModel;
use crate::LibError;
...
mod tests {
    ...
    fn test_jina_model_new_empty_api_key() {
        let result = JinaModel::new("jina/jina-embeddings-v3", "", None, None);
        assert!(result.is_err());
    ...
    fn test_all_supported_models() {
        ...
        for model_name in supported_models {
            ...
            let result = JinaModel::new(&full_model_id, "jina_test1234567890abcdef", None, None);
